...
For instance, total_volume([2, 3, 2], [6, 6, 7], [1, 2, 1]) should return 266
since (2 x 3 x 2) + (6 x 6 x 7) + (1 x 2 x 1) = 12 + 252 + 2 = 266.
Examples
...
if __name__ == '__main__':
    assert total_volume([2, 3, 2], [6, 6, 7], [1, 2, 1]) == 266
    assert total_volume([4, 2, 4], [3, 3, 3], [1, 1, 2], [2, 1, 1]) == 63
    assert total_volume([1, 1, 1]) == 1

...
if __name__ == '__main__':
    ...
    assert compound_interest(10000, 10, 0.06, 12) == 18193.97

    assert compound_interest(100, 1, 0.05, 1) == 105.0

    assert compound_interest(3500, 15, 0.1, 4) == 15399.26

    assert compound_interest(100000, 20, 0.15, 365) == 2007316.26

...
A robot has been given a list of movement instructions. Each instruction is either left, right, up or down, followed
...
if __name__ == '__main__':
    assert track_robot(["right 10", "up 50", "left 30", "down 10"]) == [-20, 40]
    assert track_robot([]) == [0, 0]
    assert track_robot(["right 100", "right 100", "up 500", "up 10000"]) == [200, 10500]

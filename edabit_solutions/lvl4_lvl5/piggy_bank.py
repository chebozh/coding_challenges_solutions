...
Write a function that returns the number of days he needs to buy his first car cost. John had some savings
(include it before counting). On the first Monday, he puts the start amount into his piggy bank.
...
if __name__ == '__main__':
    assert num_of_days(2050, 1200, 10) == 53
    # 2050: cost of car, 1200: savings, 10: start amount
    # After 53 days he can buy a car.
    assert num_of_days(10000, 2500, 50) == 123
    # After 123 days he can buy a car.

    assert num_of_days(500, 300, 50) == 4
    # After 4 days he can buy a car.

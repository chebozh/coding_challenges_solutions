...
You are in the midst of organizing all of your coding projects. It's a mess! Every file you've ever created is located
in the same folder.
...
def clean_up(files, sort):
    ...
    for file in files:
        ...
        group = [f for f in files if (f.startswith(prefix) if sort == 'prefix' else f.endswith(suffix))]
        if group not in res:
            res.append(group)
    return res
...
if __name__ == '__main__':
    assert clean_up(["ex1.html", "ex1.js", "ex2.html", "ex2.js"], "prefix") == [["ex1.html", "ex1.js"],
                                                                                ["ex2.html", "ex2.js"]]

    assert clean_up(["ex1.html", "ex1.js", "ex2.html", "ex2.js"], "suffix") == [
        ["ex1.html", "ex2.html"],
        ["ex1.js", "ex2.js"]
    ]
    ...
    assert clean_up(["_1.rb", "_2.rb", "_3.rb", "_4.rb"], "suffix") == [
        ["_1.rb", "_2.rb", "_3.rb", "_4.rb"]
    ]

    assert clean_up(["_1.rb", "_2.rb", "_3.rb", "_4.rb"], "prefix") == [
        ["_1.rb"], ["_2.rb"],
        ["_3.rb"], ["_4.rb"]
    ]

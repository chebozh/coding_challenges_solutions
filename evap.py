...
Note : Content is in fact not necessary in the body of the function "evaporator", you can use it or not use it, as you
...
def evaporator(content, evap_per_day, threshold):
    ...
    threshold = (threshold / 100) * starting_content
    days = 0
